...
def main(args: argparse.Namespace):
    ...
    logging.info("Reading video... Press 'r' to Reset, ESC to Quit.")
    last_move = None
    ...
    while True:
        ...
        if has_board:
            ...
            # Run batch inference (assumes adapter supports list of images)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video", default="test_videos/alessia1cut.mp4")
