#!/usr/bin/env python3
# https://github.com/GiorgioMegrelli/chess.com-boards-and-pieces/blob/master/fetcher.py
...
def start_process(config: dict[str, Any]) -> None:
    ...
    boards_dir = "deletemeboards/"
    pieces_dir = "deletemepieces/"
...
def main() -> None:
    start_process(load_json("chess_board_and_pieces_download_data.json"))
